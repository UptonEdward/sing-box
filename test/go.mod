...
require (
	...
	github.com/sagernet/sing-tun v0.4.0-beta.15 // indirect
...
replace (
	github.com/sagernet/quic-go => github.com/uptonedward/quic-go v0.47.0-beta.2.1
	github.com/sagernet/sing-quic => github.com/uptonedward/sing-quic v0.3.0-beta.3.1
)
