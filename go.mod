...
replace (
	github.com/sagernet/quic-go => github.com/uptonedward/quic-go v0.48.1-beta.1.1
	github.com/sagernet/sing-quic => github.com/uptonedward/sing-quic v0.3.0-rc.2.1
)
